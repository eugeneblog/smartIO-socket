        ...
        >
            <Descriptions.Item label="Start time">
                <TimePicker allowClear={false}
                            onChange={(time, timeString) => props.timeChangeHandle(time, timeString, 'start')}
                            format={'HH:mm'} id="startTime"
                            value={moment(startTime, 'HH:mm:ss')}/>
            </Descriptions.Item>
            <Descriptions.Item label="End time">
                <TimePicker onChange={(time, timeString) => props.timeChangeHandle(time, timeString, 'end')}
